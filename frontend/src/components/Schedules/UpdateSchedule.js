...
const UpdateSchedule = () => {
  const { selectedSchedule } = useParams();
  ...
  const handleSubmit = async (e) => {
    ...
    e.preventDefault();
      ...
      const response = await axios.put(`/schedule/${selectedSchedule}`, { name, mailSubject, recipients: recipientNames, triggers: selectedTriggers });
      setName('');
      setMailSubject('');
      setRecipients([]);
